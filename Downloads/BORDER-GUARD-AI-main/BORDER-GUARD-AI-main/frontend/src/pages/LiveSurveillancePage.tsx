...
export function LiveSurveillancePage({ snapshot, now, onRefreshCameras }: LiveSurveillancePageProps) {
  ...
  function handleSnapshot() {
    ...
    showToast(`Snapshot captured · ${selectedCamera.id} ${selectedCamera.name}`)
  }
  ...
  return (
    <div className="surv-page" style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
      <SurveillanceTopBar
        ...
        <div className="surv-main">
          <section className="panel surv-wall-panel">
            <header className="panel-header">
              <div>
                <h2>Live Surveillance Wall</h2>
                <p className="panel-subtitle">
                  Real-time CCTV & USB camera streams powered by YOLOv8 object detection and ByteTrack tracking.
                </p>
              </div>
            </header>
